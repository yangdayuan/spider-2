 ...
 * </a>
 *
 * @version $Revision: 1227719 $ $Date: 2012-01-06 01:45:51 +0800 (???, 06 ?? 2012) $
 * @since Validator 1.4
 */
public class UrlValidator implements Serializable {
     ...
     *  a {@link org.apache.commons.validator.routines.RegexValidator} instead ({@link #UrlValidator(org.apache.commons.validator.routines.RegexValidator, long)})
     */
    ...
    private static final String PATH_REGEX = "^(/[-\\w:@&?=+,.!/~*'%$_;\\(\\)[\\u4e00-\\u9fa5]]*)?$";
    private static final Pattern PATH_PATTERN = Pattern.compile(PATH_REGEX);

    private static final String QUERY_REGEX = "^(.*)$";
    private static final Pattern QUERY_PATTERN = Pattern.compile(QUERY_REGEX);

    private static final String LEGAL_ASCII_REGEX = "^[\\p{ASCII}[\\u4e00-\\u9fa5]]+$";
     ...
     */
    private static final org.apache.commons.validator.routines.UrlValidator DEFAULT_URL_VALIDATOR = new org.apache.commons.validator.routines.UrlValidator();
