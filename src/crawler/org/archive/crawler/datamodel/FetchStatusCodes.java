...
public interface FetchStatusCodes {
    ...
    public static final int S_BLOCKED_BY_MODIFYTIME = -2001;
    
    public static final int S_BLOCKED_BY_ATTACH = -2002;
    
    public static final int S_BLOCKED_BY_NOSTREAM = -2003;
    
    public static final int S_BLOCKED_BY_PARSE = -2004;
